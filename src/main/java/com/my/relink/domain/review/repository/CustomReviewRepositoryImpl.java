...
public class CustomReviewRepositoryImpl implements CustomReviewRepository {
    ...
    @Override
    public Page<ReviewWithExchangeItemRepositoryDto> findMyReviewsWithExchangeItems(Long userId, Pageable pageable) {
        List<ReviewWithExchangeItemRepositoryDto> content = jpaQueryFactory.select(
                        Projections.constructor(ReviewWithExchangeItemRepositoryDto.class,
                                exchangeItem.name,
                                review.star,
                                review.description,
